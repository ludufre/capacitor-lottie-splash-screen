...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorLottieSplashScreen", path: "../../../node_modules/.pnpm/capacitor-lottie-splash-screen@file+.._@capacitor+core@8.3.4/node_modules/capacitor-lottie-splash-screen")
    ],
    targets: [
        .target(
            name: "CapApp-SPM",
